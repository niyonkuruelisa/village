...
if(($credentials == null && $credentials[0] == null) || $credentials[0] != '' && $credentials[1] == '' || $credentials[2] != 3){
...
<html lang="en">
    <head>
        ...
        <title>Chairman Dashboard - <?php echo SITENAME;?> - <?php echo NAMES;?>(Chairman)</title>
